...
import { updateBasicInfoApi, getBasicInfoApi } from '@/api/setting/currency'
...
export default defineComponent({
  ...
  setup() {
    ...
    const getBasicInfo = async () => {
      const { description } = await getBasicInfoApi()
      description && Object.assign(fields, JSON.parse(description))
    }
    getBasicInfo()
