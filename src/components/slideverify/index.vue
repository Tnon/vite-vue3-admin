  ...
  <div class="jc-component__range">
    <div class="jc-range" :class="rangeStatus ? 'success' : 'unvalidate'">
      ...
      <!-- <component
        ...
        @mousedown="rangeMove"
        @click="clickth"
        :is="rangeStatus ? UserOutlined : LockOutlined"
      /> -->
      <div @mousedown="rangeMove" @click="clickth" class="svgicon">
        <component
          :is="rangeStatus ? CheckCircleOutlined : DoubleRightOutlined"
        />
      </div>
...
import { CheckCircleOutlined, DoubleRightOutlined } from '@ant-design/icons-vue'
...
.jc-component__range {
  ...
  .jc-range {
    ...
    &.success {
      background: none;
      background-color: #3bc923 !important;
      color: #fff;
